...
use crate::ui::shared::{button, on_button_exit};
...
pub fn on_button_play(_: On<Pointer<Click>>, mut next_state: ResMut<NextState<GameState>>) {
    next_state.set(GameState::InGame);
}

pub fn on_button_title(_: On<Pointer<Click>>, sounds: Res<SoundAssets>, mut commands: Commands) {
    ...
    commands
        ...
        .with_children(|parent| {
            ...
            parent
                ...
                .observe(on_button_title);

            parent
                .spawn(button("PLAY", &asset_server))
                .observe(on_button_play);
            parent
