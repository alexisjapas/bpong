...
impl Plugin for UiPlugin {
    fn build(&self, app: &mut App) {
        // HUD
        app
            .add_systems(OnEnter(GameState::InGame), hud::spawn_scores)
            .add_systems(Update, hud::update_scores.run_if(in_state(InGameState::Playing)));

        // Menu
        app
            .add_systems(OnEnter(GameState::MainMenu), menu::setup_menu)
            .add_systems(Update, (
